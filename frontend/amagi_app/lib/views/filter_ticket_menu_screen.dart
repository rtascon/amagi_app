...
class _FilterTicketMenuState extends State<FilterTicketMenu> {
  ...
  void _onRangeSelected(DateTime? start, DateTime? end, DateTime focusedDay) {
    setState(() {
      _selectedDateRange =
          start != null ? DateTimeRange(start: start, end: end ?? start) : null;
      if (_selectedDateRange != null) {
        _formatDateRange(_selectedDateRange!.start, _selectedDateRange!.end);
      }
    });
  }
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem<String>(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.help, color: AppColors.blue, size: 12),
                          SizedBox(width: 8),
                          Text('Requerimiento',
                    ...
                    DropdownMenuItem<String>(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.error, color: AppColors.orange, size: 12),
                          SizedBox(width: 8),
                          Text('Incidente', style: TextStyle(fontSize: 11.8)),
                        ],
                      ),
                    ),
                  ],
                  onChanged: _ticketIdController.text.isEmpty
                      ? (value) {
                          setState(() {
                            _selectedType = value;
                          });
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem<String>(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Nuevo', style: TextStyle(fontSize: 11.8)),
                        ],
                      ),
                    ),
                    DropdownMenuItem<String>(
                    ...
                    DropdownMenuItem<String>(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.circle, color: AppColors.orange, size: 12),
                          SizedBox(width: 8),
                          Text('En espera', style: TextStyle(fontSize: 11.8)),
                        ],
                      ),
                    ),
                    DropdownMenuItem<String>(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.check_circle_outline,
                              color: AppColors.green, size: 12),
                          SizedBox(width: 8),
                          Text('Resuelto', style: TextStyle(fontSize: 11.8)),
                        ],
                      ),
                    ),
                    DropdownMenuItem<String>(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.circle, color: AppColors.black, size: 12),
                          SizedBox(width: 8),
                          Text('Cerrado', style: TextStyle(fontSize: 11.8)),
                        ],
                      ),
                    ),
                  ],
